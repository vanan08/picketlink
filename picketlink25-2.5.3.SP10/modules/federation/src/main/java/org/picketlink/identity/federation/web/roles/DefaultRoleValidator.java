...
public class DefaultRoleValidator implements IRoleValidator {
    ...
    public boolean userInRole(String url, Map<String, String> rolesAssignUrl) {
    	if (rolesAssignUrl.containsKey(url)) {
    		String rolesValue = rolesAssignUrl.get(url);
    		StringTokenizer st = new StringTokenizer(rolesValue, ",");
        	while (st != null && st.hasMoreTokens()) {
