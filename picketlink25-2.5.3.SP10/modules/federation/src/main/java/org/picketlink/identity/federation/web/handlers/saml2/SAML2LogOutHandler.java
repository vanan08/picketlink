...
public class SAML2LogOutHandler extends BaseSAML2Handler {
    ...
    private class IDPLogOutHandler {
        ...
        public void handleStatusResponseType(SAML2HandlerRequest request, SAML2HandlerResponse response)
        	...
        	logger.info("IDPLogOutHandler - handleStatusResponseType()");
    ...
    private class SPLogOutHandler {
        ...
        public void generateSAMLRequest(SAML2HandlerRequest request, SAML2HandlerResponse response) throws ProcessingException {
        	//logger.info("SPLogOutHandler - generateSAMLRequest()");
            ...
            try {
                ...
                lot.setDestination(new URI(spConfiguration.getServiceURL()));
        ...
        private void populateSessionIndex(HttpServletRequest httpRequest, LogoutRequestType lot) throws ProcessingException,
        	...
        	Document currentAssertion = (Document) session.getAttribute(GeneralConstants.ASSERTION_SESSION_ATTRIBUTE_NAME);
        ...
        public void handleStatusResponseType(SAML2HandlerRequest request, SAML2HandlerResponse response)
        	...
        	logger.info("SPLogOutHandler - handleStatusResponseType()");
            ...
            Enumeration<String> names = session.getServletContext().getAttributeNames();
        ...
        public void handleRequestType(SAML2HandlerRequest request, SAML2HandlerResponse response) throws ProcessingException {
        	//logger.info("SPLogOutHandler - handleRequestType()");
        	SAML2Object samlObject = request.getSAML2Object();
            ...
            try {
                ...
                statusResponse = new StatusResponseType(id, XMLTimeUtil.getIssueInstant());
            ...
            response.setDestination(spConfiguration.getServiceURL());
